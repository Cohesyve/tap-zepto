...
class TopSearchedStream(ChildStream):
    API_METHOD = 'GET'
    TABLE = 'top_searched_keywords'
    KEY_PROPERTIES = ['searchTerm']
    REPLICATION_METHOD = 'INCREMENTAL'
    REPLICATION_KEY = 'start_date'

    @property
    def api_path(self):
        return '/brand-analytics-web/api/v1/kyc/top-searched-keywords'
    ...
    def sync_data(self):
        ...
        if not brands:
            raise Exception("No brands found in cache. Make sure BrandsStream runs before TopSearchedStream.")
